...
namespace Pdf_In_Browser_1
{
    public partial class _Default : Page
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine("Fuck Me Twice");
            PageDisplayer displayer = new PageDisplayer();
            //displayer.fileUpload1 = file;
            displayer.DisplayAllPages();
        }

        //***********************************************************************Testing Here For Async Page Loading**********************************************************



        public partial class PageDisplayer : SiteMaster
        {
            ...
            public string GetFileNameFromUI()
            {
                //System.Web.UI.WebControls.FileUpload fileUpload = (System.Web.UI.WebControls.FileUpload)Master.FindControl("MainContent").FindControl("FileUpload1") as System.Web.UI.WebControls.FileUpload; ;
                //System.Web.UI.WebControls.FileUpload fileUpload1 = FileUpload1;
            ...
            public PdfDocument GetDocument(string fileName)
            {
                string documentPath = GetPdfFilePath(fileName);
                PdfDocument document = null;
                System.Web.UI.WebControls.FileUpload fileUpload = (System.Web.UI.WebControls.FileUpload)Master.FindControl("FileUpload1");

                try
                {
                    fileUpload.SaveAs(documentPath);
                    document = new PdfDocument(documentPath);
                }
                catch (Exception ex)
                {
            ...
            public void AddImgToHtml(int pageNum, string path)
            {
                ...
                HtmlGenericControl customL = (HtmlGenericControl)Master.FindControl("customViewerL");
                HtmlGenericControl customR = (HtmlGenericControl)Master.FindControl("customViewerR");
                ...
                if (pageNum % 2 == 0)
                {
                    customL.Controls.Add(div);
                }
                else
                {
                    customR.Controls.Add(div);
                }
            }
